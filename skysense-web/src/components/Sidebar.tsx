...
export default function Sidebar({ activeTab, setActiveTab, isDarkMode, setIsDarkMode }: SidebarProps) {
    return (
        <aside className="w-20 lg:w-24 h-screen fixed left-0 top-0 bg-card border-r border-border flex flex-col items-center py-8 z-50 transition-colors duration-500">
            <div className="mb-12">
